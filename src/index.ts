...
let x_2 = x_1.pop();
console.log(
  `${x_1.toString()} and ${x_2} are not coming due to some personal reason`
);
...
console.log(
  `Hi, ${guest_list.pop()}, I am so sorry due to less table space I am unable to invite you`
);
console.log(
  `Hi, ${guest_list.pop()}, I am so sorry due to less table space I am unable to invite you`
);
...
console.log(
  `Hi, ${guest_list[0]}, I would like you to join us for dinner on 20th May at 8 PM in Spice Bazar`
);
console.log(
  `Hi, ${guest_list[1]}, I would like you to join us for dinner on 20th May at 8 PM in Spice Bazar`
);
...
console.log(
  `Array in reverse alphabatical order: ${modified_places.reverse()}`
);
...
let fruits: string[] =  ['orange', 'mango', 'banana','pineapple']
...
function make_shirt_1(size:string = "Large",text:string = "I Love Typescript"){
  return `The size of the shirt is ${size} and the message to be printed on the shirt
is "${text}"`
}
...
function createCar(manufacturer: string, modelName: string, additionalInfo: { [key: string]: any }): Car {
  const car: Car = {
